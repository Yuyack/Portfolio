...
import translationLongImage from "./assets/shared/翻译.png";
...
import zheguangji01 from "./assets/zheguangji/zheguangji-01.png";
import zheguangji02 from "./assets/zheguangji/zheguangji-02.png";
import zheguangji04 from "./assets/zheguangji/zheguangji-04.png";
import zheguangji05 from "./assets/zheguangji/zheguangji-05.png";
import zheguangji07 from "./assets/zheguangji/zheguangji-07.png";
import zheguangji08 from "./assets/zheguangji/zheguangji-08.png";
import zheguangji09 from "./assets/zheguangji/zheguangji-09.png";
import zheguangji10 from "./assets/zheguangji/zheguangji-10.png";
import zheguangji11 from "./assets/zheguangji/zheguangji-11.png";
import zheguangji12 from "./assets/zheguangji/zheguangji-12.png";
import zheguangji13 from "./assets/zheguangji/zheguangji-13.png";

import nomiCapture from "./assets/nomi/1.jpg";
import nomiCover from "./assets/nomi/cover.jpg";
import nomiGeneratePrompt from "./assets/nomi/2.1.jpg";
import nomiGenerateLoading from "./assets/nomi/2.2.jpg";
import nomiGenerateResult from "./assets/nomi/2.3.jpg";
import nomiModelEntry from "./assets/nomi/3.1.jpg";
import nomiModelStyleA from "./assets/nomi/3.2.1.1.jpg";
import nomiModelStyleB from "./assets/nomi/3.2.1.2.jpg";
import nomiModelStyleC from "./assets/nomi/3.2.1.3.jpg";
import nomiWearEntry from "./assets/nomi/3.2.2.1.jpg";
import nomiWearSelect from "./assets/nomi/3.2.2.2.jpg";
import nomiWearPreview from "./assets/nomi/3.2.2.3.jpg";
import nomiCommunityEntry from "./assets/nomi/4.1.jpg";
import nomiCommunityFeedA from "./assets/nomi/4.2.1.1.jpg";
import nomiCommunityFeedB from "./assets/nomi/4.2.1.2.jpg";
import nomiCommunityFeedC from "./assets/nomi/4.2.1.4.jpg";
import nomiCommunityDetailA from "./assets/nomi/4.2.3.1.jpg";
import nomiCommunityDetailB from "./assets/nomi/4.2.3.2.jpg";
import nomiCommunityPostA from "./assets/nomi/4.3.2.1.jpg";
import nomiCommunityPostB from "./assets/nomi/4.3.2.2.jpg";
import nomiCommunityPostC from "./assets/nomi/4.3.2.3.jpg";
import nomiPublishA from "./assets/nomi/5.1.jpg";
import nomiPublishB from "./assets/nomi/5.2.jpg";
import nomiAssetCenter from "./assets/nomi/6.jpg";
import nomiCommunityHome from "./assets/nomi/Homepage - Community.jpg";
import nomiCommunityLong from "./assets/nomi/Frame 2117133467.jpg";
import nomiCommunityPost from "./assets/nomi/Community - Post.jpg";
import nomiTryOn from "./assets/nomi/Community - Try on my nomi.jpg";
import nomiProfile from "./assets/nomi/7.1.jpg";
import nomiPersonaA from "./assets/nomi/7.2.jpg";
import nomiPersonaB from "./assets/nomi/7.3.jpg";
import nomiPersonaC from "./assets/nomi/7.4.jpg";
import nomiPersonaD from "./assets/nomi/7.5.jpg";
import nomiPersonaE from "./assets/nomi/7.6.jpg";
import nomiPersonaF from "./assets/nomi/7.7.jpg";
import nomiPersonaG from "./assets/nomi/7.8.jpg";
    ...
    >
      <section className="figma-stage" onClick={resetFilmRoll}>
        ...
        <aside className="work-detail-panel" aria-hidden={!isDetailOpen} onClick={keepFilmStripOpen}>
          ...
          <div className="work-detail-scroll" onScroll={handleDetailScroll}>
            {activeFullImageWork ? (
